...
int main()  {
    ...
    double Length, Width, Thickness, Postalrate;
    int Dimensions = 0;

    cout << " Enter the length, width and thickness of your letter" << endl;
    cin >> Length >> Width >> Thickness;

    Dimensions = Length * Width * Thickness;

    if ( Dimensions <= 141000) {
        cout << " The postal rate is R2.50 ";
    
    }

    else if (Dimensions > 141000 && Dimensions <= 440000) {
        cout << " The postal rate is R5.00 ";
    
    }

    else if (Dimensions > 440000 && Dimensions <= 2647500) {
        cout << " The postal rate is R6.25 ";
